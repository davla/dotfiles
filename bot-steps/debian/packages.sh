...
apt-get install apt-transport-https autoconf automake build-essential cmake \
    cmatrix cowsay curl dbus-x11 dkms docker-compose dos2unix \
    ...
    nyancat p7zip pipewire-jack playerctl podman-docker policykit-1-gnome \
    pycodestyle python3 python3-pip rar shellcheck sl \
    software-properties-common systemd-cron thunar-archive-plugin tk-dev \
