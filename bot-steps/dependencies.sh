...
SUDO_SECURE_PATH='/etc/sudoers.d/secure-path'
...
case "$DISTRO" in
    ...
    'debian')
        # We need to change the secure-path sudo option to include
        # /usr/local/bin in order to use the binaries installed later. That is
