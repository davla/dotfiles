...
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Primary>bracketright")
...
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Primary>bracketleft")
(gtk_accel_path "<Actions>/terminal-window/move-tab-left" "<Primary><Shift>bracketleft")
...
(gtk_accel_path "<Actions>/terminal-window/move-tab-right" "<Primary><Shift>bracketright")
...
(gtk_accel_path "<Actions>/terminal-window/undo-close-tab" "<Primary><Shift>w")
